...
TESTS_DIR=openfisca_plugin_inequality/tests
...
test-with-coverage:
	nosetests $(TESTS_DIR) --stop --with-coverage --cover-package=openfisca_plugin_inequality --cover-erase --cover-branches --cover-html
